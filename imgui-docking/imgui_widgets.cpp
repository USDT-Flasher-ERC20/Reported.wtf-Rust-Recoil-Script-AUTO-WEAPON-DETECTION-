...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    if (*v)
    {
        auto color_grey = ImGui::GetColorU32(ImVec4(233.0f, 0.0f, 246.0f, 1.0f));
        auto color_black = ImGui::GetColorU32(ImVec4(233.0f, 0.0f, 246.0f, 1.0f));

        //on 233, 0, 246
        window->DrawList->AddRectFilled(check_bb.Min + ImVec2(pad, pad), check_bb.Max - ImVec2(pad, pad), GetColorU32(ImVec4(233.0f, 0.0f, 246.0f, 1.0f)), style.FrameRounding);
    ...
    {
        auto color_black_off = ImGui::GetColorU32(ImVec4(0.5f, 0.5f, 0.5f, 1.0f));
        auto color_grey_off = ImGui::GetColorU32(ImVec4(0.5f, 0.5f, 0.5f, 1.0f));
    ...
    else if (*v)
    {
        ...
        //window->DrawList->AddRectFilled(check_bb.Min + ImVec2(pad, pad), check_bb.Max - ImVec2(pad, pad), GetColorU32(ImGuiCol_CheckMark), style.FrameRounding);
        // gradient
       //const float pad = ImMax(0.0f, IM_FLOOR(square_sz / 10.0f)); //niggerniggernigger
       //window->DrawList->AddRectFilledMultiColor(check_bb.Min + ImVec2(pad, pad), check_bb.Max - ImVec2(pad, pad), GetColorU32(ImVec4(0.0f, 0.0f, 0.0f, 0.05f)), GetColorU32(ImVec4(0.0f, 0.0f, 0.0f, 0.05f)), GetColorU32(ImVec4(0.0f, 0.0f, 0.0f, 0.40f)), GetColorU32(ImVec4(0.8f, 0.8f, 0.8f, 0.2f)));
        //window->DrawList->AddRectFilled(check_bb.Min + ImVec2(pad, pad), check_bb.Max - ImVec2(pad, pad), ImU32(ImColor(233, 0, 246, 255)), 0.0f, 15);
...
bool ImGui::Tab(const char* label, bool selected)
{
    ...
    draw->AddRectFilled(ImVec2(bb.Min.x, bb.Max.y - 2), bb.Max, ImColor(233, 0, 246, a));
