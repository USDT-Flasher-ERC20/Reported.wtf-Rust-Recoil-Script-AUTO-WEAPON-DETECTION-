...
double CurrentWeapon::ScopeAttachment() {
    if (GetAsyncKeyState(VK_RBUTTON) && GetAsyncKeyState(VK_LBUTTON) && config.Includes.sniper_active == true && config.Includes.recoil == true) {
        ...
        if (Script::IsCursorShowing) return 0.84;
    }
}
...
float Script::semi_pen() {
    // STANDING S + MOVING 
    if (GetAsyncKeyState(83) && GetAsyncKeyState(17) && config.Includes.ak_active == true)
    {
        return 1.14f;
    }
    // STANDING S 
    if (GetAsyncKeyState(83) && config.Includes.ak_active == true)
    {
        return 2.41;
    }
    // STANDING A + MOVING 
    if (GetAsyncKeyState(65) && GetAsyncKeyState(17) && config.Includes.ak_active == true)
    {
        return 1.14f;
    }

    // STANDING A 
    if (GetAsyncKeyState(65) && config.Includes.ak_active == true)
    {
        return 2.41;
    }
    // STANDING D + MOVING 
    if (GetAsyncKeyState(68) && GetAsyncKeyState(17) && config.Includes.ak_active == true)
    {
        return 1.14f;
    }
    // STANDING D 
    if (GetAsyncKeyState(68) && config.Includes.ak_active == true)
    {
        return 2.41;
    }
    // CROUCHING NO KEY 
    if (GetAsyncKeyState(17) && config.Includes.ak_active == true)
    {
        return 1;
    }
    // STANDING NO KEY 
...
float Script::mp5_pen() {
    // STANDING S + MOVING 
    if (GetAsyncKeyState(83) && GetAsyncKeyState(17) && config.Includes.mp5_active == true)
    {
        return 1.12f;
    }
    // STANDING S 
    if (GetAsyncKeyState(83) && config.Includes.mp5_active == true)
    {
        return 2.40;
    }
    // STANDING A + MOVING 
    if (GetAsyncKeyState(65) && GetAsyncKeyState(17) && config.Includes.mp5_active == true)
    {
        return 1.12f;
    }

    // STANDING A 
    if (GetAsyncKeyState(65) && config.Includes.mp5_active == true)
    {
        return 2.40;
    }
    // STANDING D + MOVING 
    if (GetAsyncKeyState(68) && GetAsyncKeyState(17) && config.Includes.mp5_active == true)
    {
        return 1.12f;
    }
    // STANDING D 
    if (GetAsyncKeyState(68) && config.Includes.mp5_active == true)
    {
        return 2.40;
    }
    // CROUCHING NO KEY 
    if (GetAsyncKeyState(17) && config.Includes.mp5_active == true)
    {
        return 1;
    }
    // STANDING NO KEY 
...
float Script::custom_pen() {
    // STANDING S + MOVING 
    if (GetAsyncKeyState(83) && GetAsyncKeyState(17) && config.Includes.custom_active == true)
    {
        return 1.14f;
    }
    // STANDING S 
    if (GetAsyncKeyState(83) && config.Includes.custom_active == true)
    {
        return 2.42;
    }
    // STANDING A + MOVING 
    if (GetAsyncKeyState(65) && GetAsyncKeyState(17) && config.Includes.custom_active == true)
    {
        return 1.14f;
    }

    // STANDING A 
    if (GetAsyncKeyState(65) && config.Includes.custom_active == true)
    {
        return 2.42;
    }
    // STANDING D + MOVING 
    if (GetAsyncKeyState(68) && GetAsyncKeyState(17) && config.Includes.custom_active == true)
    {
        return 1.14f;
    }
    // STANDING D 
    if (GetAsyncKeyState(68) && config.Includes.custom_active == true)
    {
        return 2.42;
    }
    // CROUCHING NO KEY 
    if (GetAsyncKeyState(17) && config.Includes.custom_active == true)
    {
        return 1.15;
    }
    // STANDING NO KEY 
...
float Script::thompson_pen() {
    // STANDING S + MOVING 
    if (GetAsyncKeyState(83) && GetAsyncKeyState(17) && config.Includes.thompson_active == true)
    {
        return 1.16f;
    }
    // STANDING S 
    if (GetAsyncKeyState(83) && config.Includes.thompson_active == true)
    {
        return 2.42;
    }
    // STANDING A + MOVING 
    if (GetAsyncKeyState(65) && GetAsyncKeyState(17) && config.Includes.thompson_active == true)
    {
        return 1.16f;
    }

    // STANDING A 
    if (GetAsyncKeyState(65) && config.Includes.thompson_active == true)
    {
        return 2.42;
    }
    // STANDING D + MOVING 
    if (GetAsyncKeyState(68) && GetAsyncKeyState(17) && config.Includes.thompson_active == true)
    {
        return 1.16f;
    }
    // STANDING D 
    if (GetAsyncKeyState(68) && config.Includes.thompson_active == true)
    {
        return 2.42;
    }
    // CROUCHING NO KEY 
    if (GetAsyncKeyState(17) && config.Includes.thompson_active == true)
    {
        return 1.16;
    }
    // STANDING NO KEY 
...
float Script::lr_pen() {
    // STANDING S + MOVING 
    if (GetAsyncKeyState(83) && GetAsyncKeyState(17) && config.Includes.lr_active == true)
    {
        return 1.14f;
    }
    // STANDING S 
    if (GetAsyncKeyState(83) && config.Includes.lr_active == true)
    {
        return 2.24;
    }
    // STANDING A + MOVING 
    if (GetAsyncKeyState(65) && GetAsyncKeyState(17) && config.Includes.lr_active == true)
    {
        return 1.14f;
    }

    // STANDING A 
    if (GetAsyncKeyState(65) && config.Includes.lr_active == true)
    {
        return 2.24;
    }
    // STANDING D + MOVING 
    if (GetAsyncKeyState(68) && GetAsyncKeyState(17) && config.Includes.lr_active == true)
    {
        return 1.14f;
    }
    // STANDING D 
    if (GetAsyncKeyState(68) && config.Includes.lr_active == true)
    {
        return 2.24;
    }
    // CROUCHING NO KEY 
    if (GetAsyncKeyState(17) && config.Includes.lr_active == true)
    {
        return 1;
    }
    // STANDING NO KEY 
...
double CurrentWeapon::x(int b) {
    if (config.Includes.randomxy_active == false) {
        if (config.Includes.ak_active == true) return (RecoilTables::Recoil_Ak47[b].x * ScopeAttachment() * BarrelAttachment() / (-0.0297555555 * (config.Includes.game_sensitivity) * 3.0 * (config.Includes.game_fov / 100.0))) / config.Includes.XCONTROL * Script::semi_pen();
        if (config.Includes.lr_active == true) return (RecoilTables::Recoil_Lr300[b].x * ScopeAttachment() * BarrelAttachment() / (-0.0295 * (config.Includes.game_sensitivity) * 3.0 * (config.Includes.game_fov / 100.0))) / config.Includes.XCONTROL * Script::lr_pen();
        if (config.Includes.mp5_active == true) return (RecoilTables::Recoil_Mp5a4[b].x * ScopeAttachment() * BarrelAttachment() / (-0.0295 * (config.Includes.game_sensitivity) * 3.0 * (config.Includes.game_fov / 100.0))) / config.Includes.XCONTROL * Script::mp5_pen();
        if (config.Includes.thompson_active == true) return (RecoilTables::Recoil_Thompson_g[b].x * ScopeAttachment() * BarrelAttachment() / (-0.0295 * (config.Includes.game_sensitivity) * 3.0 * (config.Includes.game_fov / 77.5))) / config.Includes.XCONTROL * Script::thompson_pen();
        if (config.Includes.custom_active == true) return (RecoilTables::Recoil_Custom_g[b].x * ScopeAttachment() * BarrelAttachment() / (-0.0295 * (config.Includes.game_sensitivity) * 3.0 * (config.Includes.game_fov / 77.5))) / config.Includes.XCONTROL * Script::custom_pen();
        if (config.Includes.m249_active == true)
...
double CurrentWeapon::y(int b) {                                                                                       //Y RANDOMIZATION ON AND OFF
    if (config.Includes.randomxy_active == false) {
        if (config.Includes.ak_active == true) return (RecoilTables::Recoil_Ak47[b].y * ScopeAttachment() * BarrelAttachment() / (-0.0297555555 * (config.Includes.game_sensitivity) * 3.0 * (config.Includes.game_fov / 100.0))) / config.Includes.YCONTROL * Script::semi_pen();
        if (config.Includes.lr_active == true) return (RecoilTables::Recoil_Lr300[b].y * ScopeAttachment() * BarrelAttachment() / (-0.0295 * (config.Includes.game_sensitivity) * 3.0 * (config.Includes.game_fov / 100.0))) / config.Includes.YCONTROL * Script::lr_pen();
        if (config.Includes.mp5_active == true) return (RecoilTables::Recoil_Mp5a4[b].y * ScopeAttachment() * BarrelAttachment() / (-0.0295 * (config.Includes.game_sensitivity) * 3.0 * (config.Includes.game_fov / 100.0))) / config.Includes.YCONTROL * Script::mp5_pen();
        if (config.Includes.thompson_active == true) return (RecoilTables::Recoil_Thompson_g[b].y * ScopeAttachment() * BarrelAttachment() / (-0.0295 * (config.Includes.game_sensitivity) * 3.0 * (config.Includes.game_fov / 77.5))) / config.Includes.YCONTROL * Script::thompson_pen();
        if (config.Includes.custom_active == true) return (RecoilTables::Recoil_Custom_g[b].y * ScopeAttachment() * BarrelAttachment() / (-0.0295 * (config.Includes.game_sensitivity) * 3.0 * (config.Includes.game_fov / 77.5))) / config.Includes.YCONTROL * Script::custom_pen();
        if (config.Includes.m249_active == true) return (RecoilTables::Recoil_M249[b].y * ScopeAttachment() * BarrelAttachment() * Script::m249_pen() / 4) / config.Includes.game_sensitivity / config.Includes.YCONTROL;
